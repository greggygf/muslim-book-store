				...
				<div class="row icon_box_row">
					...
					<div class="col-lg-4 icon_box_col">
						<div class="icon_box">
							...
							<div class="icon_box_text">
								<p>Khawatir buku tidak cocok? Jangan khawatir, karena apapun alasannya retur di MuslimSunnah.ID gratis & mudah!</p>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col">
						<div class="footer_content d-flex flex-lg-row flex-column align-items-center justify-content-lg-start justify-content-center">
							<div class="footer_logo"><a href="index.php">MuslimSunnah.ID</a></div>
